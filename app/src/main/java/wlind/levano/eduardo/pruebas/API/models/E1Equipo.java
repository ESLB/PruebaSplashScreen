...
public class E1Equipo {
    ...
    public E1Equipo(String nombre, Integer numero) {
        this.nombre = nombre;
        this.numero = numero;
    }

    public E1Equipo(String _id, String nombre, Integer numero, String jugadores, String administradores, String locacion, boolean completo, String equipoImagen) {
        this._id = _id;
        this.nombre = nombre;
        this.numero = numero;
